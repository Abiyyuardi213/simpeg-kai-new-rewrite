...
<head>
    ...
    <title>Manajemen Kantor - PT KAI</title>
...
<body class="hold-transition sidebar-mini layout-fixed">
                ...
                <div class="container-fluid">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('office.create') }}" class="btn btn-primary btn-sm ml-auto">
                                        ...
                                        @foreach($offices as $index => $office)
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    ...
                                                    <button class="btn btn-danger btn-sm delete-office-btn"
                                                        data-toggle="modal"
                                                        data-target="#deleteOfficeModal"
                                                        data-office-id="{{ $office->id }}">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header bg-danger text-white">
                    <h5 class="modal-title" id="deleteOfficeModalLabel"><i class="fas fa-exclamation-triangle"></i> Konfirmasi Hapus</h5>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.delete-office-btn').click(function () {
                let officeId = $(this).data('office-id');
                let deleteUrl = "{{ url('office') }}/" + officeId;
            ...
            $(".toggle-status").change(function () {
                ...
                $.post("{{ url('office') }}/" + officeId + "/toggle-status", {
                    _token: '{{ csrf_token() }}',
