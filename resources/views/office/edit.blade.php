...
<head>
    ...
    <title>Edit Kantor - PT KAI</title>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">Edit Data Kantor</h1>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container-fluid">
                <div class="card card-warning">
                    <div class="card-header">
                        <h3 class="card-title"><i class="fas fa-edit"></i> Form Edit Kantor</h3>
                    </div>
                        ...
                        <form action="{{ route('office.update', $office->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('office_name') is-invalid @enderror"
                                       name="office_name" value="{{ old('office_name', $office->office_name) }}" required
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('office_code') is-invalid @enderror"
                                       name="office_code" value="{{ old('office_code', $office->office_code) }}" required
                                       placeholder="Masukkan kode unik kantor" autocomplete="off">
                                @error('office_code')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('office_type_id') is-invalid @enderror"
                                    ...
                                    @foreach($officeTypes as $type)
                                        <option value="{{ $type->id }}" {{ old('office_type_id', $office->office_type_id) == $type->id ? 'selected' : '' }}>
                                            {{ $type->type_name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control @error('office_address') is-invalid @enderror"
                                          ...
                                          placeholder="Masukkan alamat lengkap kantor">{{ old('office_address', $office->office_address) }}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('office_phone') is-invalid @enderror"
                                       name="office_phone" value="{{ old('office_phone', $office->office_phone) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control @error('office_email') is-invalid @enderror"
                                       name="office_email" value="{{ old('office_email', $office->office_email) }}"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('office_head') is-invalid @enderror"
                                       name="office_head" value="{{ old('office_head', $office->office_head) }}"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('office_status') is-invalid @enderror"
                                    ...
                                    <option value="1" {{ old('office_status', $office->office_status) == '1' ? 'selected' : '' }}>Aktif</option>
                                    <option value="0" {{ old('office_status', $office->office_status) == '0' ? 'selected' : '' }}>Nonaktif</option>
                                </select>
                                @error('office_status')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
