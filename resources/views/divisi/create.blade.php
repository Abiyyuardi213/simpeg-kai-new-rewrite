...
<head>
    ...
    <title>Tambah Divisi - PT KAI</title>
            ...
            <div class="container-fluid">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">Form Tambah Divisi Baru</h3>
                    </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="division_name" id="division_name"
                                       ...
                                       placeholder="Masukkan nama divisi" value="{{ old('division_name') }}" required>
                                @error('division_name')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="division_code" id="division_code"
                                       ...
                                       placeholder="Contoh: DV001" value="{{ old('division_code') }}" required>
                                @error('division_code')
                                    <span class="invalid-feedback">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select name="division_status" id="division_status"
                                    ...
                                    <option value="1" {{ old('division_status') == '1' ? 'selected' : '' }}>Aktif</option>
                                    <option value="0" {{ old('division_status') == '0' ? 'selected' : '' }}>Nonaktif</option>
                                </select>
